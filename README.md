...
Championing quality with modern, scalable automation frameworks — Playwright, Bruno API, GitLab CI/CD, Cypress, Selenium, and Postman.

<p align="center">
  <img src="https://github.com/user-attachments/assets/1597a4b8-f39b-4d82-a4e1-3ef1ab019ba2" alt="Automation workspace illustration" width="400px" />
</p>
...
Building scalable test automation frameworks — API with **Bruno**, E2E with **Playwright**, mobile strategies, and CI/CD pipelines on **GitLab**.
...
C# and Java automation with **Selenium** and **Cucumber**, performance testing with **JMeter**, and DevOps with **Jenkins**, **Azure Pipelines**, and **Docker**.
